...
ax4.set_ylabel(r"$\omega/t$", fontsize=28)
...
ax7.text(5.6, -9.0, r"$t_{\perp}^{\prime} = 0.6t$", fontsize=18)
ax3.text(5.6, -9.0, r"$t_{\perp}^{\prime} = 0.75t$", fontsize=18)
ax4.text(5.6, -9.0, r"$t_{\perp}^{\prime} = 0.8t$", fontsize=18)
ax5.text(5.6, -9.0, r"$t_{\perp}^{\prime} = 0.85t$", fontsize=18)
ax6.text(5.6, -9.0, r"$t_{\perp}^{\prime} = 0.9t$", fontsize=18)
