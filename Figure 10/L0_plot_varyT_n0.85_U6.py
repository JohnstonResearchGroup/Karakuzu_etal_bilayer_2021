...
ax1.plot(1./omega0,1.-n0[:,1],color=colors[0],label=r"$t_{\perp}^{\prime}=0.0t$",marker='o',linewidth=2)
ax1.plot(xdata,ydata,color=colors[0],linewidth=2)
ax1.plot(1./omega8,1.-n8[:,1],color=colors[1],label=r"$t_{\perp}^{\prime}=0.3t$",marker='o',linewidth=2)
ax1.plot(xdata2,ydata2,color=colors[1],linewidth=2)
ax1.plot(1./omega9,1.-n9[:,1],color=colors[2],label=r"$t_{\perp}^{\prime}=0.6t$",marker='o',linewidth=2)
ax1.plot(xdata3,ydata3,color=colors[2],linewidth=2)
ax1.plot(1./omega1,1.-n1[:,1],color=colors[3],label=r"$t_{\perp}^{\prime}=0.75t$",marker='o',linewidth=2)
ax1.plot(xdata1,ydata1,color=colors[3],linewidth=2)
ax1.plot(1./omega2,1.-n2[:,1],color=colors[4],label=r"$t_{\perp}^{\prime}=0.8t$",marker='o',linewidth=2)
ax1.plot(1./omega3,1.-n3[:,1],color=colors[5],label=r"$t_{\perp}^{\prime}=0.85t$",marker='o',linewidth=2)
ax1.plot(1./omega4,1.-n4[:,1],color=colors[6],label=r"$t_{\perp}^{\prime}=0.9t$",marker='o',linewidth=2)

ax1.plot(1./omega10,1.-n10[:,1],color="blue",label=r"$t_{\perp}=2.3t$, $t_{\perp}^{\prime}=0.0$",marker='o',linewidth=2)
ax1.plot(xdata4,ydata4,color="blue",linewidth=2)

axn.plot(omegan,nn[:,1],color='black',marker='p',linestyle='dashed',linewidth=2)


axn.set_ylabel(r'$T_c/t$',fontsize=14)
axn.set_xlabel(r'$t_{\perp}^{\prime}/t$',fontsize=14)
axn.yaxis.tick_left()
...
ax1.set_ylabel(r'$1-\lambda_{s^\pm}$',fontsize=22)
ax1.set_xlabel(r'$T/t$',fontsize=22)
ax1.yaxis.tick_left() 
