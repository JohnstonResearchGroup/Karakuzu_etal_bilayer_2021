...
ax1.plot(omega0,n0[:,1],color=colors[0],label=r"$t_{\perp}=1.8$",marker='o')
ax1.plot(omega1,n1[:,1],color=colors[1],label=r"$t_{\perp}=2.0$",marker='o')
ax1.plot(omega2,n2[:,1],color=colors[2],label=r"$t_{\perp}=2.2$",marker='o')
ax1.plot(omega5,n5[:,1],color=colors[3],label=r"$t_{\perp}=2.3$",marker='o')
ax1.plot(omega3,n3[:,1],color=colors[4],label=r"$t_{\perp}=2.4$",marker='o')
ax1.plot(omega4,n4[:,1],color=colors[5],label=r"$t_{\perp}=2.6$",marker='o')





ax1.set_ylabel(r'$\lambda_{0}$',fontsize=22)
ax1.set_xlabel(r'$t_{\perp}^{\prime}$',fontsize=19)
ax1.yaxis.tick_left() 
