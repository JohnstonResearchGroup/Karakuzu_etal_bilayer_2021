...
akw_blk = np.loadtxt("Akw_tpp0.75.txt") #, usecols = range(0,33))
omega_blk = np.loadtxt("omega_tpp0.75.txt") #, usecols = range(0,33))

print("shape of akw: ",akw.T.shape)
# %%
fig, (ax2,ax1)= plt.subplots(1,2,figsize=(10,6),sharex=True, sharey=True)
...
ax1.text(5.6, -9.0, r"$t_{\perp}^{\prime}=0.75t$", fontsize=18)
