...
ax1.plot(1./omega0,1.-n0[:,1],color=colors[2],label=r"$t_{\perp}=2.4-t_{\perp}^{\prime}=0.0$",marker='o')
ax1.plot(xdata,ydata,color=colors[2])
ax1.plot(1./omega1,1.-n1[:,1],color='blue',label=r"$t_{\perp}=2.4-t_{\perp}^{\prime}=0.2$",marker='o')
ax1.plot(xdata1,ydata1,color='blue')
ax1.plot(1./omega2,1.-n2[:,1],color=colors[1],label=r"$t_{\perp}=2.0-t_{\perp}^{\prime}=0.0$",marker='o')
ax1.plot(xdata2,ydata2,color=colors[1])
ax1.plot(1./omega3,1.-n3[:,1],color=colors[3],label=r"$t_{\perp}=2.3-t_{\perp}^{\prime}=0.0$",marker='o')
...
ax1.set_ylabel(r'$1-\lambda_0$',fontsize=20)
